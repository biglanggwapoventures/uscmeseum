            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url("admin/items/{$item->id}") }}" enctype="multipart/form-data" class="ajax">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <table class="table" id="category-attributes">
                                ...
                                @foreach($item->attributes as $attribute)
                                        <tr>
                                            ...
                                            <td>{{ $attribute->is_unique ? 'YES' : 'NO' }}</td>
                                            <td>{{ $attribute->is_required ? 'YES' : 'NO' }}</td>
                                            <td>
                                                <input type="hidden" value="{{ $attribute->id }}" name="attributes[{{ $loop->index }}][attribute_id]">
                                                <input type="text" class="form-control" value="{{ $attribute->pivot->value }}" name="attributes[{{ $loop->index }}][value]">
                                            </td>
                                        </tr>
                                @endforeach
                                </tbody>
...
@push('js')
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        if(!$('#category-attributes tbody tr').length){
