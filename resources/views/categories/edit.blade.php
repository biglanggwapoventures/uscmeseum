                        ...
                        <form method="post" action="{{ url("admin/categories/{$category->id}") }}"
                            ...
                            <table class="table dynamic-table">
                                ...
                                @forelse($category->attributes as $attribute)
                                    <tr>
                                        <td>
                                            <input type="hidden" value="{{ $attribute->id }}" name="attributes[{{ $loop->index }}][id]">
                                            <input type="text" class="form-control" name="attributes[{{ $loop->index }}][name]"
                                                   data-name="attributes[idx][name]" value="{{ $attribute->name }}">
                                        </td>
                                        <td>
                                            <label>
                                                <input type="checkbox" name="attributes[{{ $loop->index }}][is_required]"
                                                       data-name="attributes[idx][is_required]" value="1" {{ $attribute->is_required ? 'checked="checked"' : '' }}> Yes
                                            </label>
                                        </td>
                                        <td>
                                            <label><input type="checkbox" name="attributes[{{ $loop->index }}][is_unique]"
                                                          data-name="attributes[idx][is_required]" value="1" {{ $attribute->is_unique ? 'checked="checked"' : '' }}>
                                                Yes</label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label><input type="checkbox" name="attributes[0][is_unique]"
                                                          data-name="attributes[idx][is_required]" value="1">
                                                Yes</label>
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-danger remove-line">
